...
function graphX2.menuBox (properties)
	...
	-- Fill
	graphX2.box {x=x1, y=y1, w=math.abs(w1), h=math.abs(h1), tex=texImg, color=col1, isSceneCoords=props.isSceneCoords}
...
function graphX2.border (properties)
	...
	-- Corners
	graphX2.box {x=x1, y=y1, w=th, h=th, color=col1, tex=ulImg, isSceneCoords=props.isSceneCoords} -- Upper-left
	graphX2.box {x=x3, y=y1, w=th, h=th, color=col1, tex=urImg, isSceneCoords=props.isSceneCoords} -- Upper-right
	graphX2.box {x=x1, y=y3, w=th, h=th, color=col1, tex=dlImg, isSceneCoords=props.isSceneCoords} -- Lower-left
	graphX2.box {x=x3, y=y3, w=th, h=th, color=col1, tex=drImg, isSceneCoords=props.isSceneCoords} -- Lower-right
	
	-- Edges
	graphX2.box {x=x1, y=y2, w=th, h=h, color=col1, tex=lImg, isSceneCoords=props.isSceneCoords} -- Left
	graphX2.box {x=x2, y=y1, w=w, h=th, color=col1, tex=uImg, isSceneCoords=props.isSceneCoords} -- Top
	graphX2.box {x=x3, y=y2, w=th, h=h, color=col1, tex=rImg, isSceneCoords=props.isSceneCoords} -- Right
	graphX2.box {x=x2, y=y3, w=w, h=th, color=col1, tex=dImg, isSceneCoords=props.isSceneCoords} -- Bottom
end
